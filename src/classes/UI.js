...
export default class UI {
  ...
  injectMachineCy(containerId, graphElements) {
    const newCy = this.#injectCy(containerId, graphElements);
    this.cy = newCy;
    return newCy;
  }

  injectConversionCy(containerId) {
    const newCy = this.#injectCy(containerId, { nodes: [], edges: [] });
    this.conversionCy = newCy;
    return newCy;
  }
